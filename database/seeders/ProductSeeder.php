...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $macbookPro = Product::factory()->create([
            ...
            'slug' => 'macbook-pro-13',
            'price' => 1299,
            'image' => '/img/products/macbook-pro-13.jpg',
            'category_id' => 1,
            'brand_id' => 1,
            'color_id' => 1,
            'size_id' => 3,
        ...
        $macbookPro = Product::factory()->create([
            ...
            'slug' => 'macbook-pro-16',
            'price' => 2399,
            'image' => '/img/products/macbook-pro-16.jpg',
            'category_id' => 1,
            'brand_id' => 1,
            'color_id' => 1,
            'size_id' => 3,
        ...
        $iPhone = Product::factory()->create([
            ...
            'slug' => 'iphone-11-pro',
            'price' => 699,
            'image' => '/img/products/iphone-11-pro.jpg',
            'category_id' => 2,
            'brand_id' => 1,
            'color_id' => 1,
            'size_id' => 1,
        ...
        $iPhone = Product::factory()->create([
            ...
            'slug' => 'iphone-12-pro',
            'price' => 999,
            'image' => '/img/products/iphone-12-pro.jpg',
            'category_id' => 2,
            'brand_id' => 1,
            'color_id' => 1,
            'size_id' => 1,
        ...
        $iPad = Product::factory()->create([
            ...
            'slug' => 'ipad-pro-12.9',
            'price' => 1099,
            'image' => '/img/products/ipad-12-pro.jpg',
            'category_id' => 3,
            'brand_id' => 1,
            'color_id' => 1,
            'size_id' => 2,
        ...
        $iPad = Product::factory()->create([
            ...
            'slug' => 'ipad-pro-11',
            'price' => 799,
            'image' => '/img/products/ipad-11-pro.jpg',
            'category_id' => 3,
            'brand_id' => 1,
            'color_id' => 1,
            'size_id' => 2,
        ...
        $airPods = Product::factory()->create([
            ...
            'slug' => 'airpods-pro',
            'price' => 249,
            'image' => '/img/products/airpods-pro.jpg',
            'category_id' => 6,
            'brand_id' => 1,
            'color_id' => 1,
            'size_id' => 1,
        ...
        $galaxy = Product::factory()->create([
            ...
            'price' => 1199,
            'image' => '/img/products/galaxy-s21-ultra.jpg',
            'category_id' => 2,
            'brand_id' => 2,
            'color_id' => 3,
            'size_id' => 2,
        ...
        $lg = Product::factory()->create([
            ...
            'slug' => 'lg-27ul850-w',
            'price' => 499,
            'image' => '/img/products/lg-27ul850-w.jpg',
            'category_id' => 5,
            'brand_id' => 3,
            'color_id' => 5,
            'size_id' => 5,
        ...
        $iMac = Product::factory()->create([
            ...
            'slug' => 'imac-27',
            'price' => 1799,
            'image' => '/img/products/imac-27.jpg',
            'category_id' => 4,
            'brand_id' => 1,
            'color_id' => 6,
            'size_id' => 4,
        ...
        $amd = Product::factory()->create([
            ...
            'price' => 799,
            'image' => '/img/products/amd-ryzen-9-5950x.jpg',
            'category_id' => 4,
            'brand_id' => 4,
            'color_id' => 1,
            'size_id' => 4,
        ...
        $i9 = Product::factory()->create([
            ...
            'price' => 529,
            'image' => '/img/products/intel-core-i9-10900k.jpg',
            'category_id' => 4,
            'brand_id' => 5,
            'color_id' => 5,
            'size_id' => 4,
